...
class Pp30FillNoPayNormalService:
    @staticmethod
...
def fill_jv(
    ...
    on_status(
        UI_TEXT["pp30_jv_no_pay_normal_log"].format(date=jv_date, sale=sale, purchase=purchase)
    )
...
def _capture_reports(ctx: Pp30FillContext) -> None:
    codes = " ".join(PP30_NO_PAY_NORMAL_REPORT_CODES)
