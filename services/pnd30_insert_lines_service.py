...
from constants.routes import ACCOUNT_CASH, ACCOUNT_PP30_PENALTY, ACCOUNT_WT, JNLTYP_PV, VOUCHER_PV_PREFIX
...
def pv_pnd30(values: Pnd30FormValues, date: str, description: str) -> JournalVoucher:
    debits: list[JournalLine] = []
    if has_amount(values.tax_withheld):
        debits.append(_debit(ACCOUNT_WT, values.tax_withheld))
