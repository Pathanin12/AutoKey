...
def fill_jv(
    ...
    on_status(UI_TEXT["pp30_jv_log"].format(date=jv_date, sale=sale, purchase=purchase))
...
def fill_pv(
    ...
    on_status(UI_TEXT["pp30_pv_log"].format(date=pv_date, due=due, decimal=decimal_amount))
